...
//
//
//            eNumOfPlayers numOfPlayers = ConsoleHandler.ChooseGameType();
//            int boardSize = ConsoleHandler.GetBoardSize();
//            m_Board = new GameBoard(boardSize);
//
//            setPlayers(numOfPlayers);
//            bool keepPlay = !startPlay(numOfPlayers, m_Board);
//
//            return keepPlay;
//        }
//
//        private bool startPlay(eNumOfPlayers i_NumOfPlayers, GameBoard i_Board)
//        {
//            bool exitGame = false;
...
//                if (canPlayerTwoPlay)
//                {
//                    if (i_NumOfPlayers == eNumOfPlayers.TwoPlayers)
//                    {
//                        exitGame = playTurn(m_Player2);
//                    }
//                    else if (i_NumOfPlayers == eNumOfPlayers.OnePlayer)
//                    {
